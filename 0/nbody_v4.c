...
int main(int argc, char **argv)
{
  ...
  p->x=aligned_alloc(ALIGN ,n * sizeof(f32));
  p->y=aligned_alloc(ALIGN ,n * sizeof(f32));
  p->z=aligned_alloc(ALIGN ,n * sizeof(f32));
  p->vx=aligned_alloc(ALIGN ,n * sizeof(f32));
  p->vy=aligned_alloc(ALIGN ,n * sizeof(f32));
  p->vz=aligned_alloc(ALIGN ,n * sizeof(f32));
  //
  init(p, n);
